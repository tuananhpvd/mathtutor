# PROGRESS_ARCHIVE.md — Lịch sử chi tiết các phiên bản cũ (v113–v120)

> Tách ra từ `docs/PROGRESS.md` ngày 2026-07-18 (mục #5 đợt rà soát) để file chính gọn
> lại — `PROGRESS.md` đọc đầu mỗi phiên nên không nên phình quá lớn. File này chỉ để
> TRA CỨU LỊCH SỬ, không cần đọc đầu phiên. `PROGRESS.md` mục 1 giữ 4 phiên bản gần nhất
> (v121–v124); mọi thứ cũ hơn nằm ở đây, cùng thứ tự cascading (1a = mới nhất trong file này).
