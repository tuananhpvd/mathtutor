  ...
  return (
    <Card className={className}>
      <CardHeader title={title}
        subtitle="Làm nhiều bài hơn, nhanh hơn, ít cần gợi ý hơn, nghĩa là đang tiến bộ" />
      <CardBody className="flex flex-col gap-3">
        <TheSoSanh nhan="Bài hoàn thành" nay={ss.ky_nay.so_bai} truoc={ss.ky_truoc.so_bai}
          totKhiTang tone="primary" />
        <TheSoSanh nhan="Thời gian trung bình mỗi bài" nay={ss.ky_nay.thoi_gian_tb_giay}
          truoc={ss.ky_truoc.thoi_gian_tb_giay} fmt={dinhDangThoiGian}
          fmtDelta={dinhDangThoiGian} totKhiTang={false} tone="accent" />
        <TheSoSanh nhan="Lượt cần gợi ý trung bình mỗi bài" nay={ss.ky_nay.goi_y_tb}
